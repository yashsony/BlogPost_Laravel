                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('buy.store') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="price" name="price" type="text" maxlength="255" class="form-control{{ $errors->has('price') ? ' is-invalid' : '' }}" autocomplete="off" />
                            @if ($errors->has('price'))
                                <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group">
                            ...
                            <input id="phone_no" name="phone_no" type="text" maxlength="255" class="form-control{{ $errors->has('phone_no') ? ' is-invalid' : '' }}" autocomplete="off" />
